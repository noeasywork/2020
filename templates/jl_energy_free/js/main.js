...
jQuery(function ($) {
  ...
  if ($("body.sticky-header").length > 0) {
    // sticky nav
    var stickyNavTop = $('#sp-header, #sp-header-2').offset().top;
    var headerFixId  = $('#sp-navigation, #sp-header-2');
    //add class
  ...
  if ($("body.layout-boxed").length > 0) {
    var windowWidth = $('#sp-header, #sp-header-2').parent().outerWidth();
    $("#sp-navigation, #sp-header-2").css({"max-width": windowWidth, "left": "auto"});
  }
